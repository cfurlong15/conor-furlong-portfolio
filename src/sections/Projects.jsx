          ...
          <div className="max-w-sm w-2/3 lg:max-w-full lg:flex min-w-2/3">
            ...
            <div className="projectBox mt-10 lg:ml-20 lg:mt-10">
              ...
              <div className="flex items-center justify-center">
                <span className="">
                  <a target="blank" className="projectButton inline-block bg-gray-200 rounded-full text-md font-extrabold text-gray-700 mr-6 mb-2 hover:bg-indigo-100" href={project.live}>Visit</a>
                </span>
                <span className="">
                  <a target="blank" className="projectButton inline-block bg-gray-200 rounded-full text-md font-extrabold text-gray-700 mr-6 mb-2 hover:bg-indigo-100" href={project.git}>GitHub</a>
                </span>
              </div>
            </div>
          </div>
